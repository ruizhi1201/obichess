      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-12">
        {!user ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h2 className="text-2xl font-bold mb-3">Sign in to save your games</h2>
            <p className="text-zinc-400 mb-8">
              Track your progress, save analyzed games, and see your improvement over time.
            </p>
            <button
              onClick={handleGoogleLogin}
              className="flex items-center gap-3 bg-white text-zinc-900 font-semibold px-6 py-3 rounded-xl hover:bg-zinc-100 transition-colors"
            >
          ...
          <div>
            ...
            {games.length === 0 ? (
              <div className="text-center py-16 text-zinc-500">
                ...
                <p className="text-sm mt-1">Upload a PGN to get started.</p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-zinc-500 text-sm">
                        {game.pgn.split('\n').filter(l => l.trim() && !l.startsWith('[')).length} moves
                      </div>
                    </div>
                  </div>
                ))}
